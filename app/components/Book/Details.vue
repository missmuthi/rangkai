    ...
    <Transition name="modal">
      ...
      >
        ...
        >
          <!-- Header -->
          <div
            class="sticky top-0 bg-white dark:bg-gray-800 border-b dark:border-gray-700 p-4 flex justify-between items-center"
          >
          ...
          >
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400">
              <span v-if="localBook?.source"
                >Source: {{ localBook.source }}</span
              >
            </div>
